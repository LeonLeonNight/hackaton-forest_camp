...
from app.domain.dto.registered_drivers_kpp_dto import(
    Registered_drivers_kppDto,
    Registered_drivers_kppListDto
)
from app.domain.services.registered_drivers_kpp_service import (
    get_all_registered_drivers_kpps, 
    delete_registered_drivers_kpp, 
    create_registered_drivers_kpp
)


api = Registered_drivers_kppDto.api
_registered_drivers_kpp = Registered_drivers_kppDto.registered_drivers_kpp
_registered_drivers_list_kpp = Registered_drivers_kppListDto.registered_drivers_list_kpp
...
class Registered_drivers_kppList(Resource):
    ...
    @api.marshal_list_with(_registered_drivers_list_kpp, envelope='data')
    def get(self):        
